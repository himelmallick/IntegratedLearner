...
This section shows a full multiclass MAE workflow where the outcome is already available in `Y` in MAE `colData`, with training/validation feature alignment and Python-style class balancing on the training set.
