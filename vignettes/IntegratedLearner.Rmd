...
```{r}
# Training data
data("PRISM", package = "IntegratedLearner")
pcl <- PRISM
...
data("NLIBD", package = "IntegratedLearner")
pcl <- NLIBD
...
```{r}
data("pregnancy", package = "IntegratedLearner")
pcl <- pregnancy
...
```{r}
data("FranzosaE_2019_CuratedMetabolome", package = "IntegratedLearner")
data("FranzosaE_2019_CuratedMetadata", package = "IntegratedLearner")
data("FranzosaE_2019_CuratedSpeciesProfile", package = "IntegratedLearner")
data("FranzosaE_2019_Validation_CuratedMetabolome", package = "IntegratedLearner")
data("FranzosaE_2019_Validation_CuratedMetadata", package = "IntegratedLearner")
data("FranzosaE_2019_Validation_CuratedSpeciesProfile", package = "IntegratedLearner")
...
```{r}
data("gene_all", package = "IntegratedLearner")
data("mir_all", package = "IntegratedLearner")
